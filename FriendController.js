angular.module("frnd").controller('FriendController', function($scope){
  ...
  //   scope.friends.map(function{
  //     for (var prop in friends.current_location){
  //       if (current_location[key] = null) {
  //         [key] === {};
  //       }
  //     }
  // });
